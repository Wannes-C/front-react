...
import {classificationOntologies,classificationOntologyLabels, classificationOntologyPrefixes} from './ClassesOntologies/List'
...
INSERT DATA {
  ...
  inst:${label}_${objectGuid} a dot:Damage, dot:${type}, dot:${defectStructural} .
...
const handleClassificationChange = (event) => {
 ...
 for (var i = 0; i < classificationOntologies.length; i++) {
  if (classificationOntologies[i].includes(event.target.value) === true) {
    var classPrefix = classificationOntologyPrefixes[i]
  } else {}
}
